  ...
  const plans = [
    {
      ...
      features: [
        ...
        "100% Offlayn Islomiy/RS256 JWT litsenziya",
        "ESC/POS Oshxona Chek Printerlari",
        "Xodimlarning PIN-kod bilan kirishi",
        "Stollar va toifalar boshqaruvi",
    ...
    },
    {
      ...
      priceAnnual: "390,000",
      desc: "O'rta va katta restoranlar uchun bulutli Ona-Bola sinxronizatsiyasi.",
      features: [
        "Cheksiz Kassa va Afitsiantlar",
        "hamrohpos.uz Bulutli Ona Server Sinxronizatsiyasi",
        "Telegram Fail-Safe Bot Xabarnomalari",
        "Qarz Daftari va Split Payments (Naqd/Karta)",
        "Geofencing Xodim Davomati (Haversine)",
        "Real-Vaqt WebSocket stollar xaritasi",
