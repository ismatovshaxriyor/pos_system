...
export default function Hero({ onOpenDemo }) {
  ...
  return (
    <section className="relative pt-10 sm:pt-16 pb-20 sm:pb-28 overflow-hidden oriental-pattern-overlay">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[320px] sm:w-[600px] h-[320px] sm:h-[400px] bg-[#0077CC]/10 blur-[120px] rounded-full pointer-events-none animate-float-slow" />
      <div className="absolute top-1/3 right-5 w-[250px] sm:w-[350px] h-[250px] sm:h-[350px] bg-[#5C9FD6]/10 blur-[100px] rounded-full pointer-events-none animate-float-slow" style={{ animationDelay: '3.5s' }} />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 animate-fade-in-up">
        
        {/* Top Tag Badge */}
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full glass-card border border-[#0077CC]/40 text-[11px] sm:text-xs font-mono text-[#0077CC] shadow-md">
            <span className="w-2 h-2 rounded-full bg-[#0077CC] animate-pulse-ring" />
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-lg sm:text-xl text-[#5C9FD6] max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              <Play className="w-4 h-4 fill-current text-[#0077CC]" />
              <span>Interaktiv Demon ko'rish</span>
            </a>
          </div>

          {/* Trust Highlights */}
          <div className="pt-8 flex flex-wrap justify-center gap-6 text-xs text-[#5C9FD6]/80 font-mono">
        ...
        <div className="mt-16 max-w-5xl mx-auto">
          <div className="glass-card rounded-2xl p-4 sm:p-6 gold-border-glow shadow-2xl relative overflow-hidden">
            ...
            {/* Terminal Top Bar */}
            <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-[#0077CC]/20">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-xs text-[#0077CC] font-semibold">
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs font-mono text-[#5C9FD6]">Tarmoq Holati:</span>
                <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-4">
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-semibold text-white flex items-center gap-2">
                    <Layers className="w-4 h-4 text-[#0077CC]" />
                    <span>Menyu Toifalari</span>
                  </h3>
                  <span className="text-xs font-mono text-[#5C9FD6]">Kassir: Sherzod M.</span>
                </div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    <div
                      key={idx}
                      className="glass-card p-3 rounded-xl hover:border-[#0077CC]/60 cursor-pointer transition-all hover:scale-[1.02] flex flex-col justify-between"
                    >
                      <span className="text-xs font-semibold text-white truncate">{p.name}</span>
                      <span className="text-[11px] font-mono text-[#0077CC] mt-2">{p.price}</span>
                    </div>
                  ))}
                </div>

                {/* Status Notice inside Terminal */}
                <div className="p-3 rounded-xl bg-[#0F2A5C] border border-[#5C9FD6]/20 flex items-center justify-between text-xs font-mono">
                  <span className="text-[#5C9FD6]">Oshxona Printeri (TCP 9100):</span>
              ...
              <div className="lg:col-span-5 glass-card p-4 rounded-xl flex flex-col justify-between space-y-4 border-[#0077CC]/30">
                <div className="space-y-3">
                  <div className="flex justify-between items-center pb-2 border-b border-[#5C9FD6]/10">
                    <span className="text-xs font-semibold text-white flex items-center gap-1.5">
                      <ShoppingBag className="w-3.5 h-3.5 text-[#0077CC]" />
                      Buyurtma Cheki #1042
                    </span>
                    <span className="text-[10px] font-mono px-2 py-0.5 rounded bg-[#0077CC]/20 text-[#0077CC]">
                      Jarayonda
                    </span>
                  </div>
                  ...
                  <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                    {cartItems.map((item) => (
                      <div key={item.id} className="flex justify-between text-xs">
                        <span className="text-[#FFFFFF] truncate max-w-[140px]">
                          {item.qty}x {item.name}
                        </span>
                        <span className="font-mono text-[#0077CC]">
                ...
                <div className="pt-3 border-t border-[#0077CC]/20 space-y-3">
                  <div className="flex justify-between items-center text-sm font-bold">
                    <span className="text-white">Jami Summa:</span>
                    <span className="text-[#0077CC] font-mono text-base">
