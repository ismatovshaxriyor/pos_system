                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-6 text-center bg-[#050D1D]/40 p-2.5 rounded-xl border border-[#0077CC]/10">
                    ...
                    <div className="flex flex-col border-x border-[#0077CC]/10">
                      ...
                      <span className="font-sans-body text-xs text-[#FFFFFF] font-medium">{dish.prepTimeMinutes} min</span>
                    </div>
                    <div className="flex flex-col">
                      <span className="font-sans-body text-[9px] font-bold tracking-widest text-[#0077CC]/70 uppercase">
                        CALORIES
                  ...
                  <div className="mt-auto flex items-center justify-between pt-4 border-t border-[#0077CC]/15">
                    <div className="flex items-center bg-[#14356F] rounded-full px-2.5 py-1 border border-[#0077CC]/20">
                      <button
                        onClick={(e) => handleQtyChange(dish.id, -1, e)}
                        className="text-[#0077CC] p-1 hover:opacity-70"
                      >
                        <span className="material-symbols-outlined text-base">remove</span>
                      </button>
                      <span className="font-sans-body text-xs font-semibold px-3 text-[#FFFFFF]">
                        {qty}
                      </span>
                      <button
                        onClick={(e) => handleQtyChange(dish.id, 1, e)}
                    ...
                    <button
                      ...
                      className={`px-7 py-2.5 rounded-full font-sans-body text-xs font-bold tracking-widest transition-all active:scale-95 uppercase ${
                        isAdded
                          ? 'bg-[#14356F] text-[#0077CC] border border-[#0077CC]'
                          : 'bg-[#0077CC] text-white hover:bg-[#4DA6E0]'
                      }`}
                    >
