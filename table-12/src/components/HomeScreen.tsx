          ...
          <div className="animate-in fade-in slide-in-from-bottom-6 duration-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                ...
                className="w-full sm:w-auto bg-[#EAF3FC] text-[#0A1F44] font-sans-body font-bold text-xs tracking-widest px-10 py-4.5 rounded-full transition-all active:scale-95 hover:bg-white gold-border-glow shadow-xl"
              >
                {t.viewMenu}
              </button>
              <button
                onClick={() => setIsOurStoryModalOpen(true)}
                className="w-full sm:w-auto border border-[#0077CC]/50 text-[#0077CC] font-sans-body font-bold text-xs tracking-widest px-10 py-4.5 rounded-full backdrop-blur-md hover:bg-[#0077CC]/10 transition-all active:scale-95"
              >
                {t.ourStory}
              </button>
            </div>
