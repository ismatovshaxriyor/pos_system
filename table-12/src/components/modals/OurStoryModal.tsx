...
export const OurStoryModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 sm:p-6 bg-[#0A1F44]/80 backdrop-blur-xl animate-in fade-in duration-200">
      <div className="relative glass-card max-w-2xl w-full rounded-2xl p-6 sm:p-10 border border-[#0077CC]/40 shadow-2xl overflow-y-auto max-h-[90vh]">
        <button
        ...
        <h2 className="font-serif-display font-bold text-3xl sm:text-4xl text-[#FFFFFF] mb-6">
          The Story of Table 12
        </h2>

        <div className="space-y-4 font-sans-body text-sm text-[#9FB0C4] leading-relaxed">
          <p>
          ...
          <div className="my-6 rounded-xl overflow-hidden border border-[#0077CC]/30 h-48">
            <img
          ...
          <p className="italic text-[#0077CC]">
            "Hospitality — Mehmondostlik — is not merely a service to us; it is a sacred cultural duty passed down through generations."
          </p>
        </div>

        <div className="mt-8 text-center border-t border-[#0077CC]/20 pt-6">
          <button
            onClick={() => setIsOurStoryModalOpen(false)}
            className="bg-[#0077CC] text-white font-sans-body text-xs font-bold tracking-widest px-8 py-3 rounded-full hover:bg-[#4DA6E0] transition-colors uppercase"
          >
            CLOSE STORY
          </button>
        </div>
